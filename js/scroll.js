...
function addColor() {
    ...
    const sectionHeight = document.querySelector("header.main-banner").clientHeight;
    ...
    const sectionHeight4 = document.querySelector("section.services").clientHeight;
    const sectionHeight5 = document.querySelector("section.container").clientHeight;
    const sectionHeight6 = document.querySelector("section.comments").clientHeight;
    const sectionHeight7 = document.querySelector("form.contact-form").clientHeight;


    const distanceFromTop = document.querySelector("header.main-banner").offsetTop;
    ...
    const distanceFromTop5 = document.querySelector("section.container").offsetTop;
    const distanceFromTop6 = document.querySelector("section.comments").offsetTop;
    const distanceFromTop7 = document.querySelector("form.contact-form").offsetTop;
...
function removeColor() {
    ...
    if (scrollPosition > sectionHeight) {
        ...
        item3.classList.remove("active");
    } if (scrollPosition > sectionHeight + sectionHeight2 + sectionHeight3 + sectionHeight4) {
        item4.classList.remove("active");
    } if (scrollPosition < sectionHeight + sectionHeight2 + sectionHeight3) {
        item4.classList.remove("active");
    } if (scrollPosition > sectionHeight + sectionHeight2 + sectionHeight3 + sectionHeight4 + sectionHeight5) {
